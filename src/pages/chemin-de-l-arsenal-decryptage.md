...
- template: section_content
  ...
  content: "Lors de la commission Urbanisme à laquelle assiste Céline David, élue
    ...
    actée du chemin a été totalement phagocytée par les accusations d'agri-bashing
    perpetrées lors de ce même conseil à l'encontre du collectif.\n\n> Nota bene:
    Des propos calomnieux pour lesquels le maire a eu la décence de présenter ses
    plus plates excuses lors du conseil municipal suivant.  \U0001F447"
  section_id: ''
  image: ''
  actions: []
